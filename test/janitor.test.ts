...
describe('Test / endpoint', () => {
    ...
    test('test with all valid params android', done => {
        request(server)
            .get("/?platform=android&osVersion=14&appVersion=1.0.0")
    ...
    test('test with all valid params ios', done => {
        request(server)
            .get("/?platform=ios&osVersion=14&appVersion=1.0.0")
    ...
    test('test with appVersion = 0.9.8', done => {
        request(server)
            .get("/?platform=ios&osVersion=14&appVersion=0.9.8")
    ...
    test('test with appVersion = 0.8.9', done => {
        request(server)
            .get("/?platform=ios&osVersion=14&appVersion=0.8.9")
    ...
    test('test with wrong params platform = symbian', done => {
        request(server)
            .get("/?platform=symbian&osVersion=14&appVersion=1.0.0")
